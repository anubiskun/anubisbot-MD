...
anuplug.help = ['cekexif','changelogs','ping','readmore','owner','donate','limit']
anuplug.tags = ['tools']
anuplug.command = /^(cekexif|changelogs|cl|p(ing)?|rm|readmore|owner|admin|sewa|donate|limit)$/i